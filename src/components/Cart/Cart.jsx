                ...
                <div className="flex flex-wrap -mx-4">
                        ...
                        {cart.length > 0 ? (
                            <div className="overflow-x-auto">
                                            ...
                                            <tr key={index} className='border-b border-green-800'>
                                                ...
                                                <td className="p-3">
                                                    <button 
                                                        ...
                                                        className='bg-red-500 text-white px-4 py-2 rounded custom-font-size'
                                                    >
                                                        Remove
                                                    </button>
                                                </td>
                                ...
                                <button 
                                    ...
                                    className='mt-4 bg-red-500 text-white px-4 py-2 rounded custom-font-size'
                                >
                                    Remove All Products
                                </button>
                            </div>
                    ...
                    <div className="w-full lg:w-1/3 px-4 mt-4 lg:mt-0">
                        <div className="bg-white border border-gray-200 p-4 rounded-lg shadow-lg">
                            ...
                            <button 
                                onClick={handleClick} 
                                className='w-full bg-green-500 text-white py-2 rounded custom-font-size'
