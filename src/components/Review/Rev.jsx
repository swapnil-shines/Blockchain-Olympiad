...
const Rev = () => {
  ...
  return (
    <div className="p-4 mx-auto bg-custom_bg bg-cover bg-no-repeat">
      <Navbar />
      ...
      <div className="flex flex-col items-center mb-4">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="bg-custom_gradient hover:scale-105 duration-300 text-black py-3 px-4 border-2 border-black rounded-full mt-4 hover:bg-custom_gradient hover:text-white ml-[5px] custom-font-size"
          >
            Submit
          </button>
        </div>
