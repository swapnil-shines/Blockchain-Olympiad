    ...
    <div className="relative flex bg-white">
      ...
      <div className="w-1/2 h-[450px] p-8 mt-8">
        <div className="grid grid-cols-2  justify-center items-center mt-14">
          ...
          <Link to="/AboutUs" className="text-black text-center bg-custom_gradient border-2 border-bg-white rounded-md text-2xl font-semibold px-6 py-8 tracking-wider hover:bg-white hover:text-white hover:border-white transition-all duration-300">
            About Us
          </Link>
        </div>
      </div>
